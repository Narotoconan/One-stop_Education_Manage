            ...
            <div class="mt-4 pb-4 operation">
                <div>
                    ...
                    <div class="d-inline-block">
                        <el-input v-model="teacherName" placeholder="老师名称"  @keypress.enter.native="getTeacher(1)"></el-input>
                    </div>
                </div>
                <div>
                ...
                <div>
                    <el-button type="warning" plain round @click="dialogAddTeacher = true">添加老师</el-button>
                    <el-button type="danger" plain round class="ml-3" @click="deleteTeachers">批量删除</el-button>
                    <el-button type="info"  plain class="ml-3" icon="el-icon-refresh-right" circle @click="getTeacher(page)"></el-button>
                </div>
            </div>
        </div>
        <div class="itemCard mt-4 pt-4 pb-4">
            <el-table
                ...
                <el-table-column
                        ...
                        width="160">
                    <template slot-scope="scope">
                        <el-tag type="success">{{ scope.row.teacherCategory }}</el-tag>
                    </template>
                </el-table-column>
                <el-table-column
                        prop="teacherInfo"
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        ...
                        <el-button type="danger" icon="el-icon-delete" circle plain @click="deleteTeacher(scope.row)"></el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-dialog
            ...
            <el-form :model="editTeacherMessage">
                ...
                <!--<el-form-item label="教师类型" :label-width="formLabelWidth">
                    <el-select v-model="editTeacherMessage.category" placeholder="请选择老师类型">
                        <el-option label="数学老师" value="10"></el-option>
                        <el-option label="英语老师" value="20"></el-option>
                        <el-option label="编程老师" value="30"></el-option>
                    </el-select>
                ...
                <el-form-item label="教师介绍" :label-width="formLabelWidth">
                    <el-input v-model="editTeacherMessage.teacherInfo" type="textarea" autocomplete="off" autosize></el-input>
                </el-form-item>
            </el-form>
    ...
    export default {
        ...
        methods:{
            ...
            edit(row){  //打开编辑教师
                ...
                //this.editTeacherMessage.category = row.category
